    ...
    .then(recipes => {
      ...
      recipes.forEach(function (recipe) {
        ...
        recipeDiv.addEventListener("click", function () {
          localStorage.setItem("name", recipe.name);
          window.location.href = "singleRecipe1.html";
        })


        // Check if recipe.rating is defined before displaying
        const ratingDisplay = recipe.rating ? `${recipe.rating} stars` : "No ratings yet";
